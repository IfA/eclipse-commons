...
/**
 * This is the item provider adapter for a {@link de.tud.et.ifa.agtele.eclipse.webpage.webpagemodel.StringValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StringValueItemProvider extends ValueItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebPageModelPackage.Literals.STRING_VALUE__VALUE,
				 true,
				 true,
				 false,
	...
	public Object getStyledText(Object object) {
		String label = crop(((StringValue)object).getValue());
    	StyledString styledLabel = new StyledString();
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_StringValue_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_StringValue_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StringValue.class)) {
			case WebPageModelPackage.STRING_VALUE__VALUE:
