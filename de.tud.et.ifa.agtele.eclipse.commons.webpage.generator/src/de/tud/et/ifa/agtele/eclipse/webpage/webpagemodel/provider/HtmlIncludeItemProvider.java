 ...
 * @generated
 */
public class HtmlIncludeItemProvider extends AbstractKeyValItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HtmlIncludeItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HtmlInclude"));
	}
	...
	public Object getStyledText(Object object) {
		String label = ((HtmlInclude)object).getName();
    	StyledString styledLabel = new StyledString();
		if (label == null || label.length() == 0) {
			styledLabel.append(getString("_UI_HtmlInclude_type"), StyledString.Style.QUALIFIER_STYLER); 
		} else {
			styledLabel.append(getString("_UI_HtmlInclude_type"), StyledString.Style.QUALIFIER_STYLER).append(" " + label);
		}
		return styledLabel;
	}
