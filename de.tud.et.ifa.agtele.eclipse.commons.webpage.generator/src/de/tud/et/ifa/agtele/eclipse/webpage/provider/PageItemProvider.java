...
import de.tud.et.ifa.agtele.eclipse.webpage.util.WebPageItemProviderAdapter;
...
/**
 * This is the item provider adapter for a {@link de.tud.et.ifa.agtele.eclipse.webpage.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider 
	extends WebPageItemProviderAdapter
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebpagePackage.Literals.PAGE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addFooterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Page_footer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Page_footer_feature", "_UI_Page_type"),
				 WebpagePackage.Literals.PAGE__FOOTER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Page.class)) {
			case WebpagePackage.PAGE__NAME:
			case WebpagePackage.PAGE__FOOTER:
