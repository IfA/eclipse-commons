...
public class ImportAdapterSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ImportAdapterPackage.CONNECTOR: {
				Connector connector = (Connector)theEObject;
				T result = caseConnector(connector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImportAdapterPackage.IMPORT_ADAPTER: {
				ImportAdapter importAdapter = (ImportAdapter)theEObject;
				T result = caseImportAdapter(importAdapter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImportAdapterPackage.FILE_SYSTEM_CONNECTOR: {
				...
				if (result == null) result = caseConnector(fileSystemConnector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
